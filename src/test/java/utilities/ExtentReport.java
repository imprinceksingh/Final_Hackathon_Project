...
public class ExtentReport implements ITestListener {
	...
	public void onStart(ITestContext testContext) 
	{
		...
		sparkReporter.config().setDocumentTitle("ZigWheels ExtentReport"); 
		...
		extent.setSystemInfo("Module", "Identify New Bikes");
		extent.setSystemInfo("Sub Module", "ZigWheels Automation");
		extent.setSystemInfo("User Name", "Prince Kumar");
